...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, GoogleApiClient.OnConnectionFailedListener, MainContractor.View, MenuFragment.MenuListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isLargeScreen()) {
            if (fragment == null || fragment instanceof CategoryGridFragment) {
                loadFragment(CategoryGridFragment.newInstance());
            }
        } else {
    ...
    public void onBackPressed() {
        if (!isLargeScreen() && mDrawer.isDrawerOpen(GravityCompat.START)) {
    ...
    private void loadFragment(Fragment fragment) {
        int containerViewId = isLargeScreen() ? R.id.contents_fragment : R.id.fragment_container;
